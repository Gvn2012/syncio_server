...
public class UserEmailController {
        ...
        @PostMapping("/{uid}/emails")
        public ResponseEntity<APIResource<AddNewEmailResponse>> addNewEmail(
                        @PathVariable("uid") String userId,
                        @Valid @RequestBody AddNewEmailRequest request) {
                APIResource<AddNewEmailResponse> response = userEmailService.addNewEmail(UUID.fromString(userId),
                                request);
        ...
        @PatchMapping("/{uid}/emails/{eid}/set-primary")
        ...
        @PostMapping("/{uid}/emails/{eid}/resend-verification")
