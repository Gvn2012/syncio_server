...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in ranking_pb2_grpc.py depends on'
...
class RankingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.RankPosts = channel.unary_unary(
                '/io.github.gvn2012.grpc.RankingService/RankPosts',
...
def add_RankingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RankPosts': grpc.unary_unary_rpc_method_handler(
                    servicer.RankPosts,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'io.github.gvn2012.grpc.RankingService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('io.github.gvn2012.grpc.RankingService', rpc_method_handlers)
