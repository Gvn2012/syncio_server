...
public class PermissionSeeder implements CommandLineRunner {
    ...
    private List<Permission> createPermissions() {
        return List.of(
                ...
                createPermission("group:manage_members", "Manage Group Members", "group", "manage_members", "content",
                        3),
                ...
                createPermission("admin:manage_permissions", "Manage Permissions", "admin", "manage_permissions",
                        "admin", 5),
    ...
    private void createRoles(List<Permission> allPermissions) {
        ...
        guest.setPermissions(
                filterPermissions(allPermissions, Set.of("post:read", "comment:read", "user:read", "group:read")));
        ...
        Role orgAdmin = createRole("ORG_ADMIN", "Organization Administrator", RoleType.PLATFORM, 80, false);
        orgAdmin.getIncludedRoles().add(user);
        orgAdmin.setPermissions(filterPermissions(allPermissions, Set.of(
                "post:moderate", "comment:moderate", "user:read", "user:suspend", "group:manage_members")));
