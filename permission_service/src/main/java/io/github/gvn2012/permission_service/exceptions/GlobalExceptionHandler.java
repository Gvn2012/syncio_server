...
public class GlobalExceptionHandler {
    ...
    public APIResource<?> handleBaseException(BaseException e) {
        log.error("BaseException: code={}, message={}, status={}", e.getCode(), e.getMessage(), e.getStatus());
    ...
    public ResponseEntity<APIResource<?>> handleException(Exception e) {
        log.error("Unexpected error caught in GlobalExceptionHandler: {}", e.getMessage(), e);
        return ResponseEntity
