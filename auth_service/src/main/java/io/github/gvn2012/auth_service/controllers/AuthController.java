...
public class AuthController {
    ...
    public ResponseEntity<APIResource<GenerateLoginTokenResponse>> refreshToken(
        ...
        // We pass null for HttpServletRequest since we don't need it for cookies here
        // locally
        APIResource<GenerateLoginTokenResponse> response = authService.refreshToken(serviceRequest, null);
