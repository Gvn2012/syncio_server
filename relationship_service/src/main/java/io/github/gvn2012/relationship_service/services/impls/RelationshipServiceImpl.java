...
public class RelationshipServiceImpl implements IRelationshipService {
    ...
    public APIResource<RelationshipResponse> follow(UUID sourceId, UUID targetId) {
        ...
        UserRelationship relationship = relationshipRepository.findBySourceUserIdAndTargetUserIdAndRelationshipType(
                sourceId, targetId, RelationshipType.FOLLOW).orElse(null);
